# Install script for directory: /home/scott/catkin_ws/src/orb_slam_rgbd/ORB_SLAM2_modified/Thirdparty/g2o/g2o/examples/interactive_slam/g2o_incremental
...
FILE(INSTALL DESTINATION "/usr/local/lib" TYPE SHARED_LIBRARY FILES "/home/scott/catkin_ws/src/orb_slam_rgbd/ORB_SLAM2_modified/Thirdparty/g2o/lib/libg2o_incremental.so")
  IF(EXISTS "$ENV{DESTDIR}/usr/local/lib/libg2o_incremental.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/lib/libg2o_incremental.so")
    FILE(RPATH_REMOVE
         FILE "$ENV{DESTDIR}/usr/local/lib/libg2o_incremental.so")
...
IF(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "Unspecified")
  ...
  IF (CMAKE_ERROR_ON_ABSOLUTE_INSTALL_DESTINATION)
    message(FATAL_ERROR "ABSOLUTE path INSTALL DESTINATION forbidden (by caller): ${CMAKE_ABSOLUTE_DESTINATION_FILES}")
  ENDIF (CMAKE_ERROR_ON_ABSOLUTE_INSTALL_DESTINATION)
FILE(INSTALL DESTINATION "/usr/local/bin" TYPE EXECUTABLE FILES "/home/scott/catkin_ws/src/orb_slam_rgbd/ORB_SLAM2_modified/Thirdparty/g2o/bin/g2o_incremental")
  IF(EXISTS "$ENV{DESTDIR}/usr/local/bin/g2o_incremental" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/g2o_incremental")
    FILE(RPATH_REMOVE
         FILE "$ENV{DESTDIR}/usr/local/bin/g2o_incremental")
...
FILE(INSTALL DESTINATION "/usr/local/include/g2o/examples/interactive_slam/g2o_incremental" TYPE FILE FILES
    "/home/scott/catkin_ws/src/orb_slam_rgbd/ORB_SLAM2_modified/Thirdparty/g2o/g2o/examples/interactive_slam/g2o_incremental/linear_solver_cholmod_online.h"
    "/home/scott/catkin_ws/src/orb_slam_rgbd/ORB_SLAM2_modified/Thirdparty/g2o/g2o/examples/interactive_slam/g2o_incremental/g2o_incremental_api.h"
    "/home/scott/catkin_ws/src/orb_slam_rgbd/ORB_SLAM2_modified/Thirdparty/g2o/g2o/examples/interactive_slam/g2o_incremental/graph_optimizer_sparse_incremental.h"
    )
ENDIF(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "Unspecified")
